...
void HAL_RCC_MCOConfig(uint32_t RCC_MCOx, uint32_t RCC_MCOSource, uint32_t RCC_MCODiv)
{
  ...
  if(RCC_MCOx == RCC_MCO1)
  {
    ...
    Sanks.Pin = MCO1_PIN;
    Sanks.Mode = GPIO_MODE_AF_PP;
    Sanks.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    Sanks.Pull = GPIO_NOPULL;
    Sanks.Alternate = GPIO_AF0_MCO;
    HAL_GPIO_Init(MCO1_GPIO_PORT, &Sanks);
  ...
  else
  {
    ...
    Sanks.Pull = GPIO_NOPULL;
    Sanks.Alternate = GPIO_AF0_MCO;
    HAL_GPIO_Init(MCO2_GPIO_PORT, &Sanks);
